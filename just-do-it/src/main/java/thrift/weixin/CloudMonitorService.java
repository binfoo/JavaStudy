...
public class CloudMonitorService {
  ...
  public interface Iface {
    ...
    public CallResultMonitor callCommand(int cmdNo, String jsonCmd1, String jsonCmd2) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public CallResultMonitor recv_callCommand() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class callCommand_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public CallResultMonitor getResult() throws TException {
  ...
  public static class callCommand_result implements org.apache.thrift.TBase<callCommand_result, callCommand_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public CallResultMonitor success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, CallResultMonitor.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public callCommand_result(callCommand_result other) {
      if (other.isSetSuccess()) {
        this.success = new CallResultMonitor(other.success);
      }
    }
    ...
    public CallResultMonitor getSuccess() {
      return this.success;
    }

    public callCommand_result setSuccess(CallResultMonitor success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((CallResultMonitor)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new CallResultMonitor();
